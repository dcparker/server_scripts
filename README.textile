'site' is a script that manages config files and starting/stopping/reloading services necessary to get a site activated or deactivated on the server.

'cilantro' is a script that manages sinatra processes.
